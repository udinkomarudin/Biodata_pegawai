...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('style/assets/css/dataTables.min.css.css') }}">
...
<body>
    ...
    <script src="{{ asset('style/assets/js/jquery-3.3.1.js') }}"></script>
    <script src="{{ asset('style/assets/js/dataTables.min.js') }}"></script>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{ url('pegawai') }}"> <i class="menu-icon fa fa-puzzle-piece"></i>Pegawai</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
